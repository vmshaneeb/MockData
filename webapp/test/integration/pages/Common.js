sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("MockData/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#MockData-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#MockData-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("MockData.test.integration.pages.Common", {
		...
		getMockServer: function() {
			return new Promise(function(success) {
				Opa5.getWindow().sap.ui.require(["MockData/localService/mockserver"], function(mockserver) {
